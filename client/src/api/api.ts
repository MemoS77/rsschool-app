...
export const CoursesTasksApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getCrossCheckPairs: async (courseId: number, pageSize: number, current: number, orderBy: string, orderDirection: string, checker: string, student: string, url: string, task: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            assertParamExists('getCrossCheckPairs', 'orderBy', orderBy)
            // verify required parameter 'orderDirection' is not null or undefined
            assertParamExists('getCrossCheckPairs', 'orderDirection', orderDirection)
            // verify required parameter 'checker' is not null or undefined
            assertParamExists('getCrossCheckPairs', 'checker', checker)
            // verify required parameter 'student' is not null or undefined
            assertParamExists('getCrossCheckPairs', 'student', student)
            // verify required parameter 'url' is not null or undefined
            assertParamExists('getCrossCheckPairs', 'url', url)
            // verify required parameter 'task' is not null or undefined
            assertParamExists('getCrossCheckPairs', 'task', task)
